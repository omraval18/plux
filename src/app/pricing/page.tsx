                ...
                return (
                    <div
                        ...
                        className={cn("relative rounded-2xl bg-white shadow-lg", {
                            "border-2 border-black shadow-blue-200": plan === "Pro",
                            "border border-gray-200": plan !== "Pro",
                        })}
                    >
                        {plan === "Pro" && (
                            <div className="absolute -top-5 left-0 right-0 mx-auto w-32 rounded-full bg-black px-3 py-2 text-sm font-medium text-white">
                                Upgrade now
                            </div>
                        )}
                            ...
                            {features.map(({ text, footnote, negative }) => (
                                <li key={text} className="flex space-x-5">
                                    <div className="flex-shrink-0">
                                        {negative ? (
                                            <CheckCircle2 className="h-6 w-6 text-white fill-gray-400" />
                                        ) : (
                                            <CheckCircle2 className="h-6 w-6  text-white fill-primary" />
                                        )}
                                    </div>
                                    {footnote ? (
                                        <div className="flex items-center space-x-1">
